...
// we create a regular react component that can provide context to any component that needs the values by wrapping around them,
...
function FavoritesContextProvider(props) {
    ...
    function itemIsFavoriteHandler(meetupId) {
        ...
        return userFavorites.some((meetup) => meetup.id == meetupI)
    }
